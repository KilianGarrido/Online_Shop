...
try {
    ...
    if (cliente == null || cliente.isEmpty()) {
    	ventas = cbd.todasVentas();
    }else{
    	int idCliente = Integer.parseInt(cliente);
    	ventas = cbd.todasVentasDeCliente(idCliente);
    }
} catch (Exception e) {
	ventas = cbd.todasVentas();
}
...
%>
<head>
    <title>ZgameK - Listado Ventas</title>
    <meta charset="utf-8">
    ...
    <style>
        ...
        .customer-listing tbody tr:hover {
...
<body>
    ...
    <div class="customer-listing" style="margin-bottom:3rem; margin-top:3rem;">
        <h2 class="text-center" style="margin-bottom:3rem;">Lista de Ventas</h2>
        <div class="customer-table-container">
            <table class="table table-striped">
                ...
                <tbody>
                    <%for(Venta v : ventas) {%>
                    <%Cliente c=cbd.dameCliente(v.getIdCliente());%>
                     <tr onclick="window.location.href='lineaVentas.jsp?idVenta=<%=v.getIdVenta()%>'">
                        <td><%=v.getIdVenta()%></td>
                        <td><%=v.getFechaHora()%></td>
                        <td class="name-cell"><img src="assets/img/Clientes/<%=c.getId() %>.jpg" alt="Cliente" class="img-fluid"><span><b><%=c.getNombre()%> <%=c.getApellidos()%></b></span></td>
