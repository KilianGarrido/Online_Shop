...
<head>
    <title>ZgameK - Elegir Juego</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 60vh;">
        <div class="col-12 col-md-8 col-lg-6">
            ...
            <p class="text-center">Elige el juego que quieres modificar</p>
            <form action="modificarProducto.jsp" method="post" style="display: flex; flex-direction: column; gap: 2rem">
                <div class="mb-3" style="margin: 3rem;">
                    <!-- For recorriendo los juegos el value es el id del juego-->
