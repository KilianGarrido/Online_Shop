...
<head>
    <title>ZgameK - Alta Cliente</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 60vh;">
        <div class="col-12 col-md-8 col-lg-6">
            ...
            <form action="operaciones.jsp?tipo=altaCliente" method="post" accept-charset="UTF-8">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="cp" name="cp" min="1" maxlength="5" required>
                </div>
                <div class="mb-3">
                    <label for="provincia" class="form-label">Provincia</label>
                    <input type="text" class="form-control" id="provincia" name="provincia" maxlength="20" required>
                </div>
