...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 80vh;">
        <div class="col-12 col-md-8 col-lg-6">
            <h1 class="text-center">Alta Juego</h1>
            <form action="operaciones.jsp?tipo=altaJuego" method="post" accept-charset="UTF-8">
                <div class="mb-3">
                    <label for="nombre" class="form-label">Nombre del juego</label>
                    <input type="text" class="form-control" id="nombre" name="nombre" maxlength="26" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="precio" name="precio" step="0.01" min="1" max="70" maxlength="5" required>
                </div>
                <div class="mb-3">
                    <label for="valoracion" class="form-label">Valoración</label>
                    <input type="number" class="form-control" id="valoracion" name="valoracion" min="0" max="5" required>
                </div>
