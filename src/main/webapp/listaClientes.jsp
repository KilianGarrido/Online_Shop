...
clientes = cbd.todosClientes();

%>
<head>
    <title>ZgameK - Listado Clientes</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="customer-listing" style="margin-bottom:3rem; margin-top:3rem;">
        <h2 class="text-center" style="margin-bottom:3rem;">Lista de Clientes</h2>
        <div class="customer-table-container">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr onclick="window.location.href='listaVentas.jsp?idCliente=<%=c.getId() %>'">
                        <td><img src="assets/img/Clientes/<%=c.getId() %>.jpg" onerror="this.onerror=null; this.src='assets/img/Clientes/usuarioGenerico.png';" alt="Cliente" class="img-fluid" style="height:85px; width: auto;"></td>
