...
clienteAux = cbd.dameCliente(idCliente);


%>

<head>
    <title>ZgameK - Modificación Cliente</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 80vh;">
        <div class="col-12 col-md-8 col-lg-6">
            ...
            <form action="operaciones.jsp?tipo=modificarCliente&idCliente=<%=clienteAux.getId()%>" method="post" accept-charset="UTF-8">
                <div class="mb-3">
                    <label for="nombre" class="form-label">Nombre</label>
                    <input type="text" class="form-control" id="nombre" name="nombre" value="<%=clienteAux.getNombre()%>" maxlength="20" required>
                </div>
                <div class="mb-3">
                    <label for="apellidos" class="form-label">Apellidos</label>
                    <input type="text" class="form-control" id="apellidos" name="apellidos" value="<%=clienteAux.getApellidos()%>" maxlength="30" required>
                </div>
                <div class="mb-3">
                    <label for="dni" class="form-label">DNI</label>
                    <input type="text" class="form-control" id="dni" name="dni" value="<%=clienteAux.getDni()%>" maxlength="9" required>
                </div>
                <div class="mb-3">
                    <label for="direccion" class="form-label">Dirección</label>
                    <input type="text" class="form-control" id="direccion" name="direccion" value="<%=clienteAux.getDireccion()%>" maxlength="50" required>
                </div>
                <div class="mb-3">
                    <label for="cp" class="form-label">Codigo Postal</label>
                    <input type="number" class="form-control" id="cp" name="cp" min="1" value="<%=clienteAux.getCp()%>" maxlength="5" required>
                </div>
                <div class="mb-3">
                    <label for="provincia" class="form-label">Provincia</label>
                    <input type="text" class="form-control"  id="provincia" name="provincia" value="<%=clienteAux.getProvincia()%>" maxlength="20" required>
                </div>
